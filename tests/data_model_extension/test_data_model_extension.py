...
def test_data_model_extension_init_invalid_spec_version_major(
    valid_data_model_extension,
):
    invalid_data_model_extension = {
        **valid_data_model_extension,
        "spec_version": "1.0.0",
    }
...
def test_data_model_extension_init_invalid_spec_version(
    valid_data_model_extension, spec_version
):
...
def test_data_model_extension_init_valid_data_schema(valid_data_model_extension):
    data_model_extension = DataModelExtension(**valid_data_model_extension)
    assert (
        data_model_extension.data_schema
        == "https://catalog.carbon-transparency.com/shipment/1.0.0/schema.json"
    )


def test_data_model_extension_init_invalid_data_schema_scheme(
    valid_data_model_extension,
):
    invalid_data = {
        **valid_data_model_extension,
        "data_schema": "http://catalog.carbon-transparency.com/shipment/1.0.0/schema.json",
    }
    with pytest.raises(ValueError, match="Invalid data schema URL scheme"):
        DataModelExtension(**invalid_data)


def test_data_model_extension_init_invalid_data_schema_netloc(
    valid_data_model_extension,
):
    invalid_data = {
        **valid_data_model_extension,
        "data_schema": "https:///shipment/1.0.0/schema.json",
    }
...
def test_data_model_extension_init_valid_data(valid_data_model_extension):
    data_model_extension = DataModelExtension(**valid_data_model_extension)
    assert data_model_extension.data == {
...
def test_data_model_extension_init_valid_documentation(valid_data_model_extension):
    data_model_extension = DataModelExtension(**valid_data_model_extension)
    assert (
        data_model_extension.documentation
        == "https://catalog.carbon-transparency.com/shipment/1.0.0/documentation.html"
    )


def test_data_model_extension_init_invalid_documentation_scheme(
    valid_data_model_extension,
):
    invalid_data = {
        **valid_data_model_extension,
        "documentation": "http://catalog.carbon-transparency.com/shipment/1.0.0/documentation.html",
    }
    with pytest.raises(ValueError, match="Invalid documentation URL scheme"):
        DataModelExtension(**invalid_data)


def test_data_model_extension_init_invalid_documentation_netloc(
    valid_data_model_extension,
):
    invalid_data = {
        **valid_data_model_extension,
        "documentation": "https:///shipment/1.0.0/documentation.html",
    }
