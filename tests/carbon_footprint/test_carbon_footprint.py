...
def test_carbon_footprint_instantiation():
    carbon_footprint = CarbonFootprint(DeclaredUnit.KILOGRAM, 1.0, 0.5, 0.3, 0.2, 0.1, CharacterizationFactors.AR6, ["AR6"], [CrossSectoralStandard.GHG_PROTOCOL], "boundary processes description", 1.0)
...
def test_carbon_footprint_invalid_declared_unit():
    with pytest.raises(ValueError) as excinfo:
        CarbonFootprint("invalid unit", 1.0, 0.5, 0.3, 0.2, 0.1, CharacterizationFactors.AR6, ["AR6"], [CrossSectoralStandard.GHG_PROTOCOL], "boundary processes description", 1.0)
...
def test_carbon_footprint_invalid_unitary_product_amount():
    with pytest.raises(ValueError):
        CarbonFootprint(DeclaredUnit.KILOGRAM, 0.0, 0.5, 0.3, 0.2, 0.1, CharacterizationFactors.AR6, ["AR6"], [CrossSectoralStandard.GHG_PROTOCOL], "boundary processes description", 1.0)


def test_carbon_footprint_invalid_p_cf_excluding_biogenic():
    with pytest.raises(ValueError):
        CarbonFootprint(DeclaredUnit.KILOGRAM, 1.0, -0.5, 0.3, 0.2, 0.1, CharacterizationFactors.AR6, ["AR6"], [CrossSectoralStandard.GHG_PROTOCOL], "boundary processes description", 1.0)
...
def test_carbon_footprint_invalid_characterization_factors():
    with pytest.raises(ValueError) as excinfo:
        CarbonFootprint(DeclaredUnit.KILOGRAM, 1.0, 0.5, 0.3, 0.2, 0.1, "AR7", ["AR6"], [CrossSectoralStandard.GHG_PROTOCOL], "boundary processes description", 1.0)
...
def test_carbon_footprint_invalid_ipcc_characterization_factors_sources():
    with pytest.raises(ValueError):
        CarbonFootprint(DeclaredUnit.KILOGRAM, 1.0, 0.5, 0.3, 0.2, 0.1, CharacterizationFactors.AR6, [], [CrossSectoralStandard.GHG_PROTOCOL], "boundary processes description", 1.0)


def test_carbon_footprint_invalid_cross_sectoral_standards_used():
    with pytest.raises(ValueError) as excinfo:
        CarbonFootprint(DeclaredUnit.KILOGRAM, 1.0, 0.5, 0.3, 0.2, 0.1, CharacterizationFactors.AR6, ["AR6"], ["invalid standard"], "boundary processes description", 1.0)
...
def test_carbon_footprint_invalid_boundary_processes_description():
    with pytest.raises(ValueError):
        CarbonFootprint(DeclaredUnit.KILOGRAM, 1.0, 0.5, 0.3, 0.2, 0.1, CharacterizationFactors.AR6, ["AR6"], [CrossSectoralStandard.GHG_PROTOCOL], "", 1.0)


def test_carbon_footprint_invalid_exempted_emissions_percent():
    with pytest.raises(ValueError):
        CarbonFootprint(DeclaredUnit.KILOGRAM, 1.0, 0.5, 0.3, 0.2, 0.1, CharacterizationFactors.AR6, ["AR6"], [CrossSectoralStandard.GHG_PROTOCOL], "boundary processes description", 6.0)
